package com.opv2.zapt.module.infra.service.codegen.inner;
...
import com.opv2.zapt.framework.apilog.core.enums.OperateTypeEnum;
...
import com.opv2.zapt.framework.common.util.date.LocalDateTimeUtils;
...
import com.opv2.zapt.framework.excel.core.annotations.DictFormat;
import com.opv2.zapt.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "zapt-module-${table.moduleName}/" + // 顶级模块
                "zapt-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "zapt-module-${table.moduleName}/" + // 顶级模块
                "zapt-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "zapt-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "zapt-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
