package com.opv2.zapt.module.infra.service.logger;
...
import com.opv2.zapt.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.opv2.zapt.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.opv2.zapt.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.opv2.zapt.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.opv2.zapt.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.opv2.zapt.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.opv2.zapt.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("zapt-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("zapt-test");
