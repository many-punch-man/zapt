package com.opv2.zapt.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.opv2.zapt.framework.common.enums.CommonStatusEnum;
import com.opv2.zapt.framework.common.exception.ServiceException;
import com.opv2.zapt.framework.common.pojo.PageResult;
import com.opv2.zapt.framework.common.util.collection.ArrayUtils;
import com.opv2.zapt.framework.common.util.collection.CollectionUtils;
import com.opv2.zapt.framework.test.core.ut.BaseDbUnitTest;
import com.opv2.zapt.module.infra.api.config.ConfigApi;
import com.opv2.zapt.module.infra.api.file.FileApi;
import com.opv2.zapt.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.opv2.zapt.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.opv2.zapt.module.system.controller.admin.user.vo.user.*;
...
import com.opv2.zapt.module.system.dal.dataobject.dept.UserPostDO;
import com.opv2.zapt.module.system.dal.dataobject.tenant.TenantDO;
import com.opv2.zapt.module.system.dal.dataobject.user.AdminUserDO;
import com.opv2.zapt.module.system.dal.mysql.dept.UserPostMapper;
import com.opv2.zapt.module.system.dal.mysql.user.AdminUserMapper;
import com.opv2.zapt.module.system.enums.common.SexEnum;
import com.opv2.zapt.module.system.service.dept.DeptService;
import com.opv2.zapt.module.system.service.dept.PostService;
import com.opv2.zapt.module.system.service.permission.PermissionService;
import com.opv2.zapt.module.system.service.tenant.TenantService;
...
import static com.opv2.zapt.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.opv2.zapt.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.opv2.zapt.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.opv2.zapt.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.opv2.zapt.framework.test.core.util.AssertUtils.assertServiceException;
import static com.opv2.zapt.framework.test.core.util.RandomUtils.*;
import static com.opv2.zapt.module.system.enums.ErrorCodeConstants.*;
import static com.opv2.zapt.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("zaptyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("zaptyuanma");
        ...
        assertEquals("zaptyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("zaptyuanma"))).thenReturn("java");
