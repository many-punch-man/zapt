...
import com.opv2.zapt.framework.common.util.cache.CacheUtils;
...
import com.opv2.zapt.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.opv2.zapt.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.opv2.zapt.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.opv2.zapt.module.system.dal.dataobject.social.SocialClientDO;
import com.opv2.zapt.module.system.dal.mysql.social.SocialClientMapper;
...
import static com.opv2.zapt.framework.common.util.collection.MapUtils.findAndThen;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${zapt.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${zapt.wxa-subscribe-message.miniprogram-state:formal}")
