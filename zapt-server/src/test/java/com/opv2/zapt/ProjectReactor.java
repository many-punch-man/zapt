...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.opv2";
    private static final String ARTIFACT_ID = "zapt";
    private static final String PACKAGE_NAME = "com.opv2.zapt";
    private static final String TITLE = "ZAPT";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.opv2";
        String artifactIdNew = "zapt";
        String packageNameNew = "com.opv2.zapt";
        String titleNew = "ZAPT";
