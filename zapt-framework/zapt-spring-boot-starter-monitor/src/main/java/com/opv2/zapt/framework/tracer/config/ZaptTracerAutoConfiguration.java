...
import com.opv2.zapt.framework.tracer.core.aop.BizTraceAspect;
import com.opv2.zapt.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "zapt.tracer", value = "enable", matchIfMissing = true)
public class ZaptTracerAutoConfiguration {
