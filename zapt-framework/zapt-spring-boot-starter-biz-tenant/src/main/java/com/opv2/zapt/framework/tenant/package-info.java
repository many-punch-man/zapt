 ...
 *      1）Spring Async：
 *          {@link com.opv2.zapt.framework.quartz.config.ZaptAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ZaptSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.opv2.zapt.framework.tenant;
